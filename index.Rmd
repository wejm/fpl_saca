...
tm <- tm + ggtitle("Transfers") + xlab('Player') + ylab('Transfers') + scale_y_continuous(breaks=seq(0, 1, (max_transfers)))
...
ts <- ts + ggtitle("Transfer spend") +ylab('Transfer spend') + xlab('Player') + scale_y_continuous(breaks=seq(0, 4, max_transfer_cost))
